; Listing generated by Microsoft (R) Optimizing Compiler Version 19.24.28314.0 
	...
	TITLE	D:\Hyperion\Hyperion Engine\zlib-1.2.11\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG95398 DB	'1.2.11', 00H
	ORG $+1
$SG95958 DB	'incorrect header check', 00H
	ORG $+1
$SG95960 DB	'unknown compression method', 00H
	ORG $+1
$SG95964 DB	'invalid window size', 00H
$SG95968 DB	'unknown compression method', 00H
	ORG $+1
$SG95970 DB	'unknown header flags set', 00H
	ORG $+3
$SG96017 DB	'header crc mismatch', 00H
$SG96034 DB	'invalid block type', 00H
	ORG $+1
$SG96038 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG96050 DB	'too many length or distance symbols', 00H
$SG96054 DB	'invalid code lengths set', 00H
	ORG $+3
$SG96064 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96070 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96073 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG96075 DB	'invalid literal/lengths set', 00H
$SG96077 DB	'invalid distances set', 00H
	ORG $+2
$SG96091 DB	'invalid literal/length code', 00H
$SG96102 DB	'invalid distance code', 00H
	ORG $+2
$SG96112 DB	'invalid distance too far back', 00H
	ORG $+2
$SG96125 DB	'incorrect data check', 00H
	ORG $+3
$SG96130 DB	'incorrect length check', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Hyperion\Hyperion Engine\zlib-1.2.11\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG95398[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG95958
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95964
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG95968
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95970
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96017
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96034
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96038
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96050
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96054
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96064
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96070
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96073
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96075
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96091
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96102
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96112
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96125
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96130
