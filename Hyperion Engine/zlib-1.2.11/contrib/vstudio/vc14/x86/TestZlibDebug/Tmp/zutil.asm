; Listing generated by Microsoft (R) Optimizing Compiler Version 19.24.28314.0 
	...
	TITLE	D:\Hyperion\Hyperion Engine\zlib-1.2.11\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG98854 DB	'need dictionary', 00H
$SG98855 DB	'stream end', 00H
	ORG $+1
$SG98857 DB	'file error', 00H
	ORG $+1
$SG98858 DB	'stream error', 00H
	ORG $+3
$SG98859 DB	'data error', 00H
	ORG $+1
$SG98860 DB	'insufficient memory', 00H
$SG98861 DB	'buffer error', 00H
	ORG $+3
$SG98862 DB	'incompatible version', 00H
_DATA	ENDS
...
_DATA	SEGMENT
	ORG $+3
$SG98865 DB	'1.2.11', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Hyperion\Hyperion Engine\zlib-1.2.11\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
