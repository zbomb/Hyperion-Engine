; Listing generated by Microsoft (R) Optimizing Compiler Version 19.24.28314.0 
	...
	TITLE	D:\Hyperion\Hyperion Engine\zlib-1.2.11\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG95340 DB	'1.2.11', 00H
	ORG $+1
$SG95726 DB	'invalid block type', 00H
	ORG $+1
$SG95731 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG95743 DB	'too many length or distance symbols', 00H
$SG95747 DB	'invalid code lengths set', 00H
	ORG $+3
$SG95758 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG95766 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG95769 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG95771 DB	'invalid literal/lengths set', 00H
$SG95773 DB	'invalid distances set', 00H
	ORG $+2
$SG95789 DB	'invalid literal/length code', 00H
$SG95801 DB	'invalid distance code', 00H
	ORG $+2
$SG95806 DB	'invalid distance too far back', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Hyperion\Hyperion Engine\zlib-1.2.11\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG95340[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95726
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95731
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95743
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG95747
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95758
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95766
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95769
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG95771
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95789
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95801
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95806
