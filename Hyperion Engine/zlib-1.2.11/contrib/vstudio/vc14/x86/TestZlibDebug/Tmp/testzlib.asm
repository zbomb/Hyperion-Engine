; Listing generated by Microsoft (R) Optimizing Compiler Version 19.24.28314.0 
	...
	TITLE	D:\Hyperion\Hyperion Engine\zlib-1.2.11\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG98356 DB	'rb', 00H
	ORG $+5
$SG98417 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG98420 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG98421 DB	'file %s read, %u bytes', 0aH, 00H
$SG98425 DB	'1.2.11', 00H
	ORG $+1
$SG98426 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG98427 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG98428 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG98429 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG98430 DB	'1.2.11', 00H
	ORG $+1
$SG98431 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG98432 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG98433 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG98434 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG98437 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Hyperion\Hyperion Engine\zlib-1.2.11\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
